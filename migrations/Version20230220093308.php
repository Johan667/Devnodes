 ...
 */
final class Version20230220093308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, comments_id INT DEFAULT NULL, received_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_9474526C63379586 (comments_id), INDEX IDX_9474526CB821E5F5 (received_id), INDEX IDX_9474526C727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mission (id INT AUTO_INCREMENT NOT NULL, send_mission_id INT DEFAULT NULL, receive_mission_id INT DEFAULT NULL, title VARCHAR(150) NOT NULL, object VARCHAR(255) DEFAULT NULL, start_date DATE NOT NULL, is_read TINYINT(1) DEFAULT NULL, description LONGTEXT DEFAULT NULL, add_file VARCHAR(255) DEFAULT NULL, frenquency VARCHAR(255) DEFAULT NULL, status LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_9067F23CA16D3CEB (send_mission_id), INDEX IDX_9067F23C73176E35 (receive_mission_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
